...
PKG_LIB_FILE	= liblibproxy0.1.so
PKG_LIB_FILE8	= liblibproxy0.1.so
PKG_LIB_FILE9	= libtcl9libproxy0.1.so
PKG_STUB_LIB_FILE = liblibproxystub0.1.a
...
top_builddir	= /home/danilo/Downloads/tcl-libproxy
