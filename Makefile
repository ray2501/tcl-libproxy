...
PKG_SOURCES	=  tclproxy.c
PKG_OBJECTS	=  tclproxy.o
...
PKG_LIB_FILE	= liblibproxy0.2.so
PKG_LIB_FILE8	= liblibproxy0.2.so
PKG_LIB_FILE9	= libtcl9libproxy0.2.so
PKG_STUB_LIB_FILE = liblibproxystub0.2.a
...
top_builddir	= /home/danilo/Public/tcl-libproxy
...
PKG_CFLAGS	=  -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/libproxy
